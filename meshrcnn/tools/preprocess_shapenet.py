...
hdlr = logging.FileHandler('preprocess.log')
...
#     for sid in os.listdir(args.r2n2_dir):
    for sid in ['02828884', '04256520', '03001627', '03636649', '04379243']:
        try:
            ...
            logger.info(e)
            logger.info("!!! skipping over: ", args.r2n2_dir+sid)
...
def handle_model(args, sid, mid, i, N):
    try:
        ...
        if verts.shape[0] <= 6000:
            ...
            logger.info('Verts > 6000 for: '+ str(sid)+ ' '+ str(mid))
            return None
    except Exception as e:
        logger.info(e)
        logger.info('!!! skipping over: '+ str(sid)+ ' '+str(mid))
        return None
