...
class Element:
    ...
    def addGIF(self, gif_path):
      h1 = '<h4 align="center">'+gif_path.split('/')[-1].replace('.gif', '')+'</h4>'
      h2 = '<img src="'+gif_path+'" width="300" />'
      self.htmlCode += h1
      self.htmlCode += h2
      # '<img src="https://media.giphy.com/media/iii3EL3YYN6t4m7Mx5/giphy.gif" width="300" />'
      # 
