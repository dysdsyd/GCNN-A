...
class BaseOptions:
    ...
    def initialize(self):
        # data params
        self.parser.add_argument('--method', required=True, default='egcn', help='method could be gcn, zgcn, egcn')
        ...
        self.parser.add_argument('--load_cache', action='store_false', help='load files from cache or sratch')
        # network params
    ...
    def parse(self, extra=None):
        ...
        if extra == None:
            ...
            self.opt, unknown = self.parser.parse_known_args(extra.split())
